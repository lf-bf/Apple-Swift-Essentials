 ...
 */
var walkingChallenges = ["Walk 5km a day", "Walk 15km in a week"]
var runningChallenges = ["Run 2km in 30 minutes", "Run a Marathon once a month"]
...
if challengesCommited.isEmpty{
    ...
    print("You have chosen \(challengesCommited)")
}else{
