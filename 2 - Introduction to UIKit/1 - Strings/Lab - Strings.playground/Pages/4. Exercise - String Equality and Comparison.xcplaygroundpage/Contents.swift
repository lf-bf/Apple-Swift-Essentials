 ...
 */
let nameInCaps = "LUIZ FERNANDO"
let name = "luiz fernando"
...
// Alternstive using ternary operator
junior.hasSuffix("Jr") ? print("We found a second generation name!"): print(" We didn't found anything")
...
// Alternative
textToSearchThrough.contains(textToSearchFor) ? print("Found It!") : print("Nothing was found")
