...
var favoriteBook = Book(title: "Maniac", author: "Benjamin Labatut", pages: 354, price: 70.0)
print(favoriteBook)
/*:
...
var oldMacbook = Laptop(yearPurchased: 2013)
var newMacbook = Laptop(yearPurchased: 2017)
/*:
...
var someoneHeight = Height(heightInches: 65)
...
var myHeight = Height(heightInches: 68)
print(myHeight)
