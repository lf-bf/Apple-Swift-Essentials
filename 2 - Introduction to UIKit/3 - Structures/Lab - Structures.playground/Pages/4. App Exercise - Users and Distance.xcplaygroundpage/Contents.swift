...
var luiz = User(name: "Luiz", height: 1.72, age: 17, weight: 65, activityLevel: 8)
print("Name: \(luiz.name),\nHeight: \(luiz.height) meters high,\nAge: \(luiz.age),\nWeight: \(luiz.weight),\nActivity Level: \(luiz.activityLevel)")
...
var kilometer = Distance(feet: 5249.344)
