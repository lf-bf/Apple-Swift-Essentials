...
func progressUpdate(steps:Double, goal:Double){
    steps < goal * 0.10 ? print("You're almost there!"): print("You're over halfway there!")
    steps < goal * 0.90 ? print("You're almost there!"): print("You have beaten your goal!")
}
progressUpdate(steps: 2450, goal: 20000)
...
func pacing(currentDistance:Double, totalDistance:Double, currentTime:Double, goalTime:Double){
     ...
     let targetPace = goalTime / totalDistance
    currentPace <= targetPace ? print("Keep it up!"): print("You've got to push it just a bit harder!")
}
pacing(currentDistance: 5.0, totalDistance: 10, currentTime: 30, goalTime: 60)
/*:
